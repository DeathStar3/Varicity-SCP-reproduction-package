...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.accept = function (visitor) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, visitor.visit(this.sourceFile)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.visit(this.sourceFile, visitor)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Parser.prototype.visit = function (node, visitor) {
        return __awaiter(this, void 0, void 0, function () {
            var _i, _a, child;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        child = _a[_i];
                        return [4 /*yield*/, visitor.visit(child)];
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, this.visit(child, visitor)];
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4:
...
var FileNotFoundException = /** @class */ (function (_super) {
    ...
    function FileNotFoundException(fileName) {
        var _this = _super.call(this, fileName + " isn't in the project") || this;
